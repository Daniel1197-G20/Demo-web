...
export default function AuthLayout() {
  return (
    <div className="min-h-screen bg-cream-base flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 bg-gradient-to-br from-tory-600 via-tory-500 to-tory-700 p-8 sm:p-12 lg:p-16 flex flex-col justify-between text-white relative overflow-hidden">
        {/* Ambient background blur circles */}
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-white/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-tory-900/20 rounded-full blur-3xl pointer-events-none" />

        {/* Top Logo */}
        <div className="relative z-10">
          <Link to="/" className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-white text-tory-500 flex items-center justify-center shadow-lg">
              <Heart className="w-6 h-6 fill-current" />
            </div>
            <div>
              <span className="font-display font-extrabold text-2xl tracking-tight text-white block">
                Tory's <span className="text-tory-200">Treats</span>
              </span>
              <span className="text-xs text-tory-100 uppercase tracking-widest font-semibold">
        ...
        <div className="my-12 relative z-10 max-w-lg">
          ...
          <p className="text-tory-100 text-sm sm:text-base leading-relaxed">
          ...
          <div className="mt-8 p-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15">
            ...
            <p className="text-xs font-bold text-tory-200 mt-2">
        ...
        {/* Bottom Footer */}
        <div className="relative z-10 text-xs text-tory-200">
