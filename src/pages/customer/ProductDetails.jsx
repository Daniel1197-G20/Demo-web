    ...
    return (
      <PageContainer>
        <div className="text-center py-16">
          <h1 className="text-2xl font-bold text-charcoal-900 font-display">Treat Not Found</h1>
          <p className="text-sm text-charcoal-600 mt-2">
            The requested artisanal treat is currently unavailable or has been rotated out.
          </p>
          <Link to="/shop" className="inline-block mt-4 text-brand-700 font-bold hover:underline">
            ← Browse All Treats
          </Link>
        </div>
      </PageContainer>
